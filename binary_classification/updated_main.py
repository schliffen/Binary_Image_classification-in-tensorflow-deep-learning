...
flags.DEFINE_bool('test', True, 'run testing')
#
...
#
flags.DEFINE_string('log_path', cwd + '/mynet_2/log/', 'path to my models log (training)')
flags.DEFINE_string('chkpnt_path', cwd + '/mynet_2/chkpnt', 'path to my models checkpoints')
